...
(
    ...
    constraint fk1_poursuites foreign key (ID_ASSOCIATION_POURSUIVANT) 
      references ASSOCIATIONS (ID_ASSOCIATION) on delete cascade,
    constraint fk2_poursuites foreign key (ID_OBJECTIF_POURSUIVI) 
      references OBJECTIFS (ID_OBJECTIF) on delete cascade
