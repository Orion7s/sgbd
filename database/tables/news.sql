...
(
    ...
    constraint fk1_news foreign key (ID_NEWS)
      references CONTENUS (ID_CONTENU) on delete cascade,
    constraint fk2_news foreign key (ID_ASSOCIATION_MEMBRE_NEWS, ID_ADHERENT_MEMBRE_NEWS)
      references BUREAUX(ID_ASSOCIATION_MEMBRE, ID_ADHERENT_MEMBRE) on delete cascade,
